...
const TABS = [
  { key: 'popular', label: 'Popular', fetcher: getPopularTVShows },
  { key: 'top_rated', label: 'Top Rated', fetcher: getTopRatedTVShows },
]
...
export default function TVShows() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-24 sm:px-6 sm:pt-28 lg:px-8">
      <h1 className="font-display text-2xl text-ivory-50 sm:text-3xl">TV Shows</h1>
      ...
      <MovieGrid
        ...
        hasMore={hasMore}
        emptyMessage="No TV shows found in this category right now."
      />
